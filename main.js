...
sort.addEventListener('click', () => {
    ...
    if (srt == 'increment') {
        srt = 'decrement';
        sort.style.background = 'url(../symbol/sort-up-black.png)';
        sort.addEventListener('mouseout', (event) => {
            event.target.style.background = 'url(../symbol/sort-up.png)';
        });
        sort.addEventListener('mouseover', (event) => {
            event.target.style.background = 'url(../symbol/sort-up-black.png)';
        });
        ...
        srt = 'increment';
        sort.style.background = 'url(../to-do-list/symbol/sort-down-black.png)';
        sort.addEventListener('mouseout', (event) => {
            event.target.style.background = 'url(../to-do-list/symbol/sort-down.png)';
        });
        sort.addEventListener('mouseover', (event) => {
            event.target.style.background = 'url(../to-do-list/symbol/sort-down-black.png)';
        });
        arr.sort((a, b) => {
            if (a < b)
                return 1;
